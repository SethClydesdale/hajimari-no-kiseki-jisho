    ...
    var insertAds = function() {
      ...
      if (content && logo) {
        ...
        if (window.screen.width < 728) {
          ...
          // top page ad
          logo.insertAdjacentHTML('afterend', '<div class="ad-container ad-top">' + ad.replace('{SLOT}', '8249052960') + '</div>');
        ...
        // standard ads
          ...
          // top page ad
          logo.insertAdjacentHTML('afterend', '<div class="ad-container ad-top">' + ad.replace('{SLOT}', '6877660342') + '</div>');
          (adsbygoogle = window.adsbygoogle || []).push({});
